...
def aggregate_join_nyc_to_buffered_networkx_stations(new_column_suffix, nyc_gdf, _networkx_gdf, meters):
    
    networkx_gdf = _networkx_gdf.copy()
    networkx_gdf.geometry = networkx_gdf.buffer(meters)
